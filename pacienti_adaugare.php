                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                    ...
                                    <input type="text" name="nume_pacient" class="form-control" id="nume_pacient" aria-describedby="nume_pacient" placeholder="Introduceti nume">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                                <label for="prenume_pacient">Prenume</label>
                                <input type="text" name="prenume_pacient" class="form-control" id="prenume_pacient" placeholder="Introduceti prenume">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="cnp" class="form-control" id="cnp" placeholder="CNP">
                            </div>
                        </div>
                        <div class="col-6">
                            <div class="form-group">
                    ...
                    <div class="row">
                        <div class="col-6">
                            <div class="form-group">
                                ...
                                <input type="date" name="data_nastere" class="form-control" id="data_nastere" placeholder="Data nasterii">
                            </div>
                        </div>
                    </div>
                    <div class="form-group">
